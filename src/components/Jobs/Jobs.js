...
const Jobs = ({ allJobs,  setPage, page, pageCount}) => {
    ...
    return (
        <div>
            <div className = "background" style={{height: 800+'px'}}>
                ...
                <div className = "pagination d-flex justify-content-center" style={{marginTop: 30+'%', backgroundColor: 'white'}}>
                    {page > 1 && (
